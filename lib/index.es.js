...
function Overlay(_a, ref) {
    var children = _a.children, visible = _a.visible, style = _a.style, rest = __rest(_a, ["children", "visible", "style"]);
    var display = visible ? 'block' : 'none';
    var styleObj = __assign({ position: 'absolute', display: display }, style);
    return (React.createElement("div", __assign({ style: styleObj }, rest, { ref: ref }), children));
}
var Overlay$1 = React.forwardRef(Overlay);
...
function OverlayMenu(props) {
    ...
    var innerStyle = __assign({}, style, placementStyle[placement]);
    var ref = useRef(null);
    ...
    var menu = (React.createElement(Overlay$1, { style: innerStyle, visible: visible, ref: ref },
        React.createElement(Menu, { prefixCls: "ant-dropdown-menu", onClick: handleClick, selectable: false }, items.map(function (item) {
            ...
            return React.createElement(Menu.Item, { key: item.key }, item.name);
        }))));
    return menu;
}
var OverlayMenu$1 = React.memo(OverlayMenu);
...
function ContextMenu(_a) {
    ...
    var _f = useState({}), style = _f[0], setStyle = _f[1];
    ...
    return (React.createElement(OverlayMenu$1, { style: style, visible: visible, placement: placement, items: items, onSelect: handleMenuSelect, onClose: function () { return setVisible(false); } }));
}
...
function OverlayInput(props) {
    ...
    var _a = useState(value), innerValue = _a[0], setInnerValue = _a[1];
    ...
    var content = (React.createElement(Overlay$1, { style: style, visible: visible },
...
var OverlayInput$1 = React.memo(OverlayInput);
...
function EditorInput() {
    ...
    return (React.createElement(OverlayInput$1, { visible: visible, value: value, style: style, onConfirm: handleInputConfirm, onCancel: function () { return setVisible(false); } }));
}
...
var edResultEdit = {
  ...
  editSelect: function editSelect(shape, key, value) {
    var graph = this.graph;
    var bbox = Util.getBBox(shape, shape.getParent());
...
function TreeEditor() {
    ...
    var _a = useState(null), editor = _a[0], setEditor = _a[1];
    useEffect(function () {
    ...
    return (React.createElement("div", { ref: containerRef, style: {
        ...
        React.createElement(Provider, { value: editor }, editor && (React.createElement(React.Fragment, null,
            React.createElement(ContextMenu, null),
            React.createElement(EditorInput, null))))));
}

export default TreeEditor;
export { EditorContext, ContextMenu, EditorInput, Editor };
